...
# kedro_notebook_project documentation build
...
from kedro_notebook_project import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_notebook_project"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_notebook_projectdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_notebook_project.tex",
        "kedro_notebook_project Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_notebook_project",
        "Project kedro_notebook_project codebase.",
        "Data-Science",
    )
]
